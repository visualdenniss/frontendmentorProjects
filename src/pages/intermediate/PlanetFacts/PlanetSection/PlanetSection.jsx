        ...
        >
            <section className="planetFacts-main-content-container">
                <div className="planetFacts-tabs-container">
                    <button id='planetOverview' className={`planetFacts-tab-btn planetFacts-tab-btn-active planet-${(planet?.name)}-btn`}
                    onClick={handleTabOverview}
                    >
                        <span className="planetFacts-tab-btn-index">01</span> Overview
                    </button>
                    <button id='planetInternal' className={`planetFacts-tab-btn planet-${(planet?.name)}-btn`}
                    ...
                    <button id='planetSurface' className={`planetFacts-tab-btn planet-${(planet?.name)}-btn`}
